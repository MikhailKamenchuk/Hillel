...
t.exports = {
lang: "ru",
ordersMail: "orders@javascript.ru",
providers: [ {
name: "Facebook",
id: "facebook"
}, {
...
144: function(t, e, n) {
"use strict";
const r = new (n(228))("en"), i = n(143).lang;
let o = console.error;
function s() {
...
239: function(t, e, n) {
"use strict";
n(240), e.login = n(248), n(249), e.Modal = n(155), e.resizeOnload = n(182), n(253), 
n(254), n(255), n(256), n(259), n(260), n(454), n(146).init(), n(261), n(262);
},
240: function(t, e, n) {
"use strict";
n(241), n(247);
...
return e.prototype = $.prototype, e;
}(), function() {
var t = et;
...
set: function(t) {
var e = "template" === this.localName, n = e ? this.content : this, r = v.call(document, this.localName);
...
n = document.documentElement.clientWidth <= o, r = document.querySelector('meta[name="viewport"]').content, 
r = r.replace(/user-scalable=\w+/, "user-scalable=" + (n ? "yes" : "no")), document.querySelector('meta[name="viewport"]').content = r, 
function() {
let t = "//" + window.disqus_shortname + ".disqus.com/embed.js";
...
if (n.top > document.documentElement.clientHeight + 150 || n.bottom < -150) return;
...
o.src = t, o.setAttribute("data-timestamp", +new Date()), document.head.appendChild(o), 
o.onload = (() => {
...
window.addEventListener("resize-internal", s), window.addEventListener("scroll", s), 
window.addEventListener("resize", s), "loading" == document.readyState ? document.addEventListener("DOMContentLoaded", s) : s();
},
254: function(t, e, n) {
"use strict";
document.addEventListener("click", function(t) {
...
256: function(t, e, n) {
"use strict";
var r = n(258), i = ~navigator.userAgent.toLowerCase().indexOf("mac os x") ? "ctrl" : "alt";
function o() {
...
let t = new Date(this.getAttribute("from"));
if ("{" === this.getAttribute("to")[0]) return;
let e = new Date(this.getAttribute("to")), n = this.getAttribute("format"), r = this.getAttribute("format");
t.getFullYear() === e.getFullYear() && (n = n.replace(/ YY(YY)?$/g, "")), this.innerHTML = this.format(t, n) + " – " + this.format(e, r, this.hasAttribute("with-zone"));
}
}
...
let t, e = this.getAttribute("weekdays").split(",").map(Number), n = this.getAttribute("from"), r = this.getAttribute("to");
[e, n, r] = o(e, n, r, -new Date().getTimezoneOffset()), t = "ru" === s ? [ "", "пн", "вт", "ср", "чт", "пт", "сб", "вс" ] : [ "", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun" ], 
e = e.map(e => t[e]), e = "ru" === s ? e.join("/") : e.join(", ");
let a = this.hasAttribute("with-zone") ? " " + i() : "";
this.innerHTML = e + " " + n + " – " + r + a;
}
}
...
n._d = new Date(k(t));
}), r.version = "2.22.0", e = xe, r.fn = dn, r.min = function() {
